...
\begin{align}
     \myvec{\frac{4}{3}&2\\2&3}\vec{x}=\myvec{8\\12}
\end{align}
...
\begin{align}
     \myvec{\frac{4}{3}&2& 8\\
           2 & 3 & 12}
          \xleftrightarrow{R_1 \leftarrow\frac{3}{4}{R_1}}
    \myvec{1&\frac{3}{2}&6\\
        2&3&12}\\
        \xleftrightarrow{R_2\leftarrow R_2 -2R_1}
    \myvec{1&\frac{3}{2}&6\\0&0&0}
    \end{align}
 So by reduction of the ($2\times3$) matrix
 \begin{align}
     \myvec{\frac{4}{3}&2&8\\2&3&12}
 \end{align}
 gives matrix with 2 non zero row,so i'ts rank is 1. 
   \begin{align}
       \myvec{\frac{4}{3}&2\\2&3}
   \end{align} 
  The rank of the above matrix is also 1.
   
   $\therefore$ lines are Consistent and gives infinite solutions.
...
\end{figure}
   $\therefore$ This figure verifies that two lines are intersecting at point \vec{P} = \myvec{6\\0}.
\end{document}
